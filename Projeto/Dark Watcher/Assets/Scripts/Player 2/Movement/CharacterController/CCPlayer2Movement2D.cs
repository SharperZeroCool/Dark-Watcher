...
public class CCPlayer2Movement2D : CCPlayer2Movement {

	private bool canMove = true;

	private void Update() {
		bool jumpPressed = Input.GetButtonDown("Jump Player2");
	...
	private void FixedUpdate() {
		...
		horizontalAxis = Input.GetAxisRaw("Horizontal Player2");
		verticalAxis = Input.GetAxisRaw("Vertical Player2");
		jumpButton = Input.GetButton("Jump Player2");
		runningButton = Input.GetButton("Sprint Player2");
